...
console.log(luxon.luxon.DateTime);
const LuxonDateTime = luxon.DateTime;

export default {
    template: `
<q-card v-if="card!=null" ref="card" class="nicegui-card [>*]:pointer-events-none" flat="this.detached" :bordered="this.detached" :class="classes()">
    ...
    computed: {
        ...
        finished_at() {
            ...
            return LuxonDateTime.fromJSDate(this.card.finished_at).toFormat("yyyy-LL-dd HH:mm")
        },
        tags() {
