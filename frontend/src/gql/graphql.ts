...
export type GetProjectBoardQuery = { __typename?: 'Query', project?: { __typename: 'AssignedTeamRole' } | { __typename: 'Estimate' } | { __typename: 'EstimateStatistics' } | { __typename: 'EstimateType' } | { __typename: 'Project', name: string, tasks: Array<{ __typename?: 'Task', id: any, dbId: number, name: string, state: TaskState, finishedAt?: any | null, orderId?: number | null, attached: boolean, priority: TaskPriority, parent?: { __typename?: 'Task', dbId: number } | null, tags: Array<{ __typename?: 'Tag', text: string, color: string }>, progress: { __typename?: 'TaskProgress', pessimistic: number, average: number, optimistic: number, active: boolean } }>, priorities: Array<{ __typename?: 'Tag', key?: string | null, text: string, color: string }> } | { __typename: 'Role' } | { __typename: 'Task' } | { __typename: 'Team' } | { __typename: 'User' } | null };
